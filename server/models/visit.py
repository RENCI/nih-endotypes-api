...
class Visit(Model):
    ...
    """
    def __init__(self, time: str=None, lat: str=None, lon: str=None, visit_type: str=None, icd_codes: str=None, exposures: List[Exposure]=None):
        """
    ...
    def visit_type(self, visit_type: str):
        ...
        if visit_type is not None and not re.search('^(INPATIENT|OUTPATIENT|EMERGENCY|inpatient|outpatient|emergency)$', visit_type):
            raise ValueError("Invalid value for `visit_type`, must be a follow pattern or equal to `/^(INPATIENT|OUTPATIENT|EMERGENCY|inpatient|outpatient|emergency)$/`")
    ...
    def icd_codes(self) -> str:
        ...
        comma-separated standard ICD-9 or ICD-10 codes associated with the visit
    ...
    @exposures.setter
    def exposures(self, exposures: List[Exposure]):
        """
