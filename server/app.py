...
if __name__ == '__main__':
    ...
    cserver = parser.get('connexion', 'server')
    if not cserver:
        app = connexion.App(__name__, specification_dir='./swagger/')
    else:
        app = connexion.App(__name__, specification_dir='./swagger/', server=cserver)
    app.add_api('swagger.yaml', arguments={'title': 'Endotypes API'})
